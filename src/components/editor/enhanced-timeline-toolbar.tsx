    ...
    <div className="enhanced-timeline-toolbar bg-card border-b border-border p-2">
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-1 border-r border-border pr-4">
          ...
          <Button
            ...
            className={isPlaying ? "bg-red-100 hover:bg-red-200" : "bg-green-100 hover:bg-green-200"}
          >
      ...
      <div className="mt-2 text-xs text-muted-foreground border-t border-border pt-2">
        <div className="flex gap-6">
          ...
          <span><kbd>Ctrl+D</kbd> 复制</span>
          <span><kbd>Ctrl+A</kbd> 全选</span>
          <span><kbd>Ctrl+Z</kbd> 撤销</span>
          <span><kbd>Ctrl+Y</kbd> 重做</span>
          <span><kbd>Ctrl +/-</kbd> 缩放</span>
          <span><kbd>Ctrl+0</kbd> 适合窗口</span>
          <span><kbd>←/→</kbd> 前进/后退</span>
        </div>
      </div>
    </div>
  );
